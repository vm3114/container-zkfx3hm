...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zkfx3hm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zkfx3hm.containers.anotherwebservice.com/
...
```
git clone git@github.com:vm3114/container-zkfx3hm.git
cd container-zkfx3hm
```
...
```
docker attach container-zkfx3hm
```
